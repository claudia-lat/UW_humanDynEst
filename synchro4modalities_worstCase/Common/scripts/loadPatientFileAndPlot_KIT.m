function missingData = loadPatientFileAndPlot
    ...
    % user setup
    rawDataPath = 'C:\Documents\aslab\data\Lowerbody_healthy1_2011-11_KIT'; % path of the data
    ...
    exercisePrefix = {'HFEO_SUP', 'KEFO_SIT', 'KHEF_SUP', 'SQUA_STD', 'STSO_SIT'}; % exercises to plot
