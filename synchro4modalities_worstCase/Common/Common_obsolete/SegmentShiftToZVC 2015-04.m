...
% % %         end
    ...
    if halfSeg
        ...
        existingLength = length(currSegmentName);
        ...
        useTimeEndVal = sort([useTimeEndVal useTimeVal]);
        useTimeEndInd = sort([useTimeEndInd useTimeInd]);
        
        useTimeStartVal = sort([useTimeStartVal useTimeVal]);
        useTimeStartInd = sort([useTimeStartInd useTimeInd]);
    end
