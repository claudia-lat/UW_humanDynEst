function [jointAngle, jointTime, segmentInfo] = dataSource_TRO2009(dataSettings, baseFolder, jointPath, segPath, motionSet, Ntemplate)
    ...
    switch dataSettings.segmentProfileMod
        case 'normal'
            fullSegmentsFlag = 1;
...
% 27: LeftArm2
    ...
    jointData = motionAnalysis_TRO2009_jointFileRead(jointPath);
    segmentData = motionAnalysis_TRO2009_segFileRead(segPath); % though, there is an instance attached to jointPath
%     save(fullfile(baseFolder, 'tro2009_joint.mat'), 'jointData', 'segmentData');
