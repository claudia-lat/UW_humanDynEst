...
% obj.zeroInitialDatapoints = str2num(obj.settings.dataNormalization(1));
%   DC offset
%   1 - calc from the mean of first 10 values
%   2 - calc from the first entry of all segments
%   3 - calc from every other segment
% obj.normalizeJointAngles  = str2num(obj.settings.dataNormalization(2));
%   normalize joint angle
%   1 - calc from the full array
%   2 - for testing, only calc from the first entry
% obj.absJointAngles        = str2num(obj.settings.dataNormalization(3));
