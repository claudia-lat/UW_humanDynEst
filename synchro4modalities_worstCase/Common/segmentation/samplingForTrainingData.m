...
%             pullDataForTrainingPatients(obj, sampleRules, obj.label_unknown, obj.settings.dimStrack, permissibleIndStruct, returnLimit);
        ...
        [trainingDataNotSegment, trainingLabelNotSegment, trainingIndNotSegment, trainingNameNotSegment] = ...
            pullDataForTrainingPatients(obj, sampleRules, obj.label_notSegment, obj.settings.dimStrack, permissibleIndStruct, returnLimit);
